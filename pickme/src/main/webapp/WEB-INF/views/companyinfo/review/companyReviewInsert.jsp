	...
	<div class="container">
		<form action="/review/companyReviewInsert" id="companyReviewInsertForm" method="post">
			...
			<div class="form-group">  
	        	...
	        	<input type="text" class="kv-svg rating-loading" value="0" data-size="md" name="reviewRate" title="">
	 		</div>
	 		<div class="form-group">
	 		...
	 		<div class="form-group">  
	        	...
	        	<input type="text" class="kv-svg rating-loading" value="0" data-size="md" name="reviewPromotion" title="">
	 		</div>
	 		<div class="form-group">  
				<label for="companyName"> 복지및급여 : </label> 
	        	<input type="text" class="kv-svg rating-loading" value="0" data-size="md" name="reviewWelfare" title="">
	 		</div>
	 		<div class="form-group">  
				<label for="companyName"> 사내문화 : </label> 
	        	<input type="text" class="kv-svg rating-loading" value="0" data-size="md" name="reviewCulture" title="">
	 		</div>
	 		<div class="form-group">  
				<label for="companyName"> 업무와삶의균형 : </label> 
	        	<input type="text" class="kv-svg rating-loading" value="0" data-size="md" name="reviewBalance" title="">
	 		</div>
	 		<div class="form-group">  
				<label for="companyName"> 경영진 : </label> 
	        	<input type="text" class="kv-svg rating-loading" value="0" data-size="md" name="reviewCeorate" title="">
	 		</div>
	 		<div class="form-group">
				<label for="companyName"> CEO에대한견해 : </label> 
	        	<input type="text" class="kv-svg rating-loading" value="0" data-size="md" name="reviewCeosupport" title="">
	 		</div>
		</form>
	</div>
